	...
	*/
	...
	class ezSQL_mysqli extends ezSQLcore
	{
		...
		*/
		...
		function ezSQL_mysqli($dbuser='root', $dbpassword='', $dbname='gis', $dbhost='localhost', $encoding='')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function quick_connect($dbuser='root', $dbpassword='', $dbname='gis', $dbhost='localhost', $dbport='3306', $encoding='')
		{
			$return_val = false;
