      ...
      return Container(
        ...
        child: MaterialButton( 
          ...
          child: Column( 
            ...
            children:[
              Icon(DynamicIcon, color: Colors.white, size: 50,),
            ...
            Flexible(
              child: Container(
                ...
                child: GridView.count(
                  ...
                  crossAxisCount: 2,
                  children: [ 
                    _menuDashboard('Absensi', Icons.punch_clock_rounded, AbsenPage()),
                    _menuDashboard('Cuti', Icons.file_copy, AbsenPage()),
                    _menuDashboard('Perdin', Icons.bus_alert, AbsenPage()),
                    _menuDashboard('Gaji', Icons.monetization_on, AbsenPage())
                  ] 
                )
              ) 
            )
